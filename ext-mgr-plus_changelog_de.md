...
* Bei phpBB werden ab 3.3.14 für die deaktivierten und nicht-installierten Erweiterungen separate Template Arrays generiert, damit beiden Gruppen ebenfalls getrennt dargestellt werden können. Entsprechend bei EMP das Template so angepasst, dass ebenfalls beide Gruppen separat behandelt werden, damit die nicht-installierten Erweiterungen ab phpBB 3.3.14 weiterhin angezeigt werden können. Dabei wird das Verhalten von phpBB 3.3.14 bei einer niedrigeren phpBB Version nachgeahmt. Die Anpassung wurde auf folgender Basis vorgenommen: [phpBB #6665](https://github.com/phpbb/phpbb/pull/6665) und [phpBB #6743](https://github.com/phpbb/phpbb/pull/6743).
